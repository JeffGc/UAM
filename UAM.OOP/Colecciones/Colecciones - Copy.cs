...
namespace UAM.OOP
{
    class Colecciones : ImplementarInterface
    {
        ...
        public void ListaString<T>()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Cantidad en la lista = {0}", contar);
