...
namespace UAM.OOP
{
	public class Estudiante : Persona //// : HEREDA DE PERSONA
	{
		#region Atributos
		...
		public Estudiante(string universidad, string carrera, int ingreso, string nombre, string apellidos, int identificacion, 
            int fechaNacimiento, int telefono, string correo) 
            // Asigna datos al contructor base
